    ...
    return `<li class="serie">
                ...
                <ul class="score">
                  <li class="score__star" data-score="1">
                    <i class="icon--score${
                     this.serie.score >= 1 ?'fas': 'far' }fa-star" title="1/5"></i>
                  </li>
                  <li class="score__star" data-score="2">
                    <i class="icon--score ${
                      this.serie.score >= 2  ?'fas': 'far' } fa-star" title="2/5"></i>
                  </li>
                  <li class="score__star" data-score="3">
                    <i class="icon--score ${
                      this.serie.score >= 3  ?'fas': 'far' } fa-star" title="3/5"></i>
                  </li>
                  <li class="score__star" data-score="4">
                    <i class="icon--score ${
                      this.serie.score >= 4  ?'fas': 'far' } fa-star" title="4/5"></i>
                  </li>
                  <li class="score__star" data-score="5">
                    <i class="icon--score ${
                      this.serie.score === 5  ?'fas': 'far' } fa-star" title="5/5"></i>
                  </li>
                </ul>
